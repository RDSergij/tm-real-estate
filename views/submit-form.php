...
<form class="" action="" method="post" enctype="multipart/form-data" name="" id="property_submit_format">
	<div>
		<label class="label-block" id="property_title_label" for="property_title_input"> Title </label>
		<input type="text" class ="form-textbox"  id="property_title_input" name="property[title]" value="">
	</div>

	<div>
	<label class="label-block" id="property_price_label" for="property_price_input"> Price </label>
	<input type="number" class="form-textbox" id="property_price_input" name="property[meta][price]" step="any" value="">
	</div>
	<div>
	<label class="label-block" id="property_description_label" for="property_description_input"> Description </label>
	<textarea id="property_description_input" class="form-textarea" name="property[description]" cols="40" rows="6"></textarea>
	</div>
	<div>
	<label class="label-block" id="property_thumb_label" for="property_thumb_label"> Image </label>
...
<div>
	<label class="label-block" id="property_type_label" for="property_type_input"> Type </label>
	...
	<div>
	<label class="label-block" id="property_bathrooms_label" for="property_bathrooms_input"> Bathrooms </label>
	<input type="number" id="property_bathrooms_input"  min="0" name="property[meta][bathrooms]" value="">
	</div>
	
<div>
	<label class="label-block" id="property_bedrooms_label" for="property_bedrooms_input"> Bedrooms </label>
	<input type="number" id="property_bedrooms_input" name="property[meta][bedrooms]" min="0" value="">
	</div>
<div>
	<label class="label-block" id="property_area_label" for="property_area_input"> Area </label>
...
<div>
	...
	<span class="btn btn-success fileinput-button">
		...
		<span class="btn-success" >Add files...</span>
